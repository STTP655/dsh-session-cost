window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		// 关闭图标用 DSH 自己的那枚（原生 Modal 用的就是它），保证图标集统一。
		const IconClose = primitives === undefined ? undefined : primitives.IconCloseOutlineRegular;
...
.sc-card {
	...
	/* 玻璃卡片：先把主题层色作为兜底，再用 color-mix 降到 78% 不透明。
	   模糊半径 20px（DSH 菜单配方是 40px，这里按观感收小），饱和度沿用同一配方；
	   值写死以免注入的样式表取不到 --dsw-menu-backdrop-filter。 */
...
.sc-bar[data-empty="true"] { opacity: .3 }
.sc-axis {
	display: flex;
	justify-content: space-between;
	padding: 0 10px;
					...
					(0, react_jsx_runtime.jsx)("div", {
						...
						children: bars.map((bar, i) => {
							...
							return (0, react_jsx_runtime.jsx)("div", {
								...
								style: {
									height: (empty ? 3 : Math.max(ratios[i] * 100, 4)).toFixed(2) + "%",
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				children: [
					...
					(0, react_jsx_runtime.jsxs)("div", {
						className: "sc-total",
						children: [
							(0, react_jsx_runtime.jsx)("span", { children: t("total") }),
							(0, react_jsx_runtime.jsx)("span", {
						...
						(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								(0, react_jsx_runtime.jsx)("button", {
									...
									"aria-label": t("close"),
									onClick: close,
									children: IconClose === undefined
										? "✕"
										: (0, react_jsx_runtime.jsx)(IconClose, { size: 14 })
								})
							]
						}),
						body
